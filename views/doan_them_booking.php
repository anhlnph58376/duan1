<?php
$page_title = "Thêm Booking cho Đoàn #" . str_pad($departure['id'], 6, '0', STR_PAD_LEFT);
?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <p><strong>Tour:</strong>
                                                <?= htmlspecialchars($departure['tour_name'] ?? 'N/A') ?></p>
                                        </div>
                                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Thêm booking cho đoàn</h6>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="index.php?action=departure_create_booking">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="pax_count">Số người <span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="total_amount"
                                                        name="total_amount" value="<?= $departure['base_price'] ?? 0 ?>"
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p class="mb-3"><i class="fas fa-info-circle text-info"></i>
                                        <strong>Thêm booking cho đoàn</strong>
                                    </p>
                                    <ul class="mb-0">
                                        <li>Chọn khách hàng từ danh sách có sẵn</li>
                                        <li>Nhập số lượng người tham gia</li>
                                        <li>Nhập tổng số tiền</li>
                                        <li>Chọn trạng thái booking phù hợp</li>
                                        <li>Booking sẽ được tự động liên kết với đoàn</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
