...
<body id="page-top">
                                            ...
                                            <select class="form-control" id="tour_id" name="tour_id" required>
                                                ...
                                                <?php foreach ($tours as $tour): ?>
                                                    <option value="<?= $tour['id'] ?>">
                                                        <?= htmlspecialchars($tour['name']) ?> - <?= number_format($tour['base_price']) ?> VND
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
    ...
    <script>
        // Auto-fill departure name when tour is selected
        ...
        // Update departure name when departure date changes
