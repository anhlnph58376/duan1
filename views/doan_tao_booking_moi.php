                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p><strong>Giá tour:</strong>
                                                <?= number_format($departure['base_price'] ?? 0) ?> VND</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="customer_phone"
                                                        name="customer_phone" placeholder="Nhập số điện thoại" required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" id="customer_email"
                                                        name="customer_email" placeholder="Nhập email">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="deposit_amount"
                                                        name="deposit_amount" value="0" min="0" step="1000">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p class="mb-3"><i class="fas fa-info-circle text-info"></i>
                                        <strong>Tạo booking mới cho đoàn</strong>
                                    </p>
                                    <ul class="mb-0">
