                        ...
                        <div class="col-lg-4">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body text-center">
                                    <?php if (!empty($guide['photo']) && file_exists($guide['photo'])): ?>
                                        <img src="<?= htmlspecialchars($guide['photo']) ?>" class="rounded-circle mb-3" 
                                    ...
                                    <p class="text-muted">Mã: <?= htmlspecialchars($guide['guide_code']) ?></p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <p><?= $guide['date_of_birth'] ? date('d/m/Y', strtotime($guide['date_of_birth'])) : 'N/A' ?></p>
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <p><?= htmlspecialchars($guide['type'] ?? 'N/A') ?></p>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <p><?= htmlspecialchars($guide['license_number'] ?? 'N/A') ?></p>
                                        </div>
                                        <div class="col-md-6">
                                            <strong>Ngày cấp:</strong>
                                            <p><?= $guide['license_issue_date'] ? date('d/m/Y', strtotime($guide['license_issue_date'])) : 'N/A' ?></p>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <p>
                                                <?php
                                                $healthStatus = $guide['health_status'] ?? 'Unknown';
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p><?= htmlspecialchars($guide['health_notes'] ?? 'Không có') ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
