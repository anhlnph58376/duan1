...
<head>
    ...
    <style>
        ...
        .image-deleted {
            opacity: 0.3;
            pointer-events: none; /* Ngăn chặn click vào ảnh đã xóa */
            filter: grayscale(100%);
        }
        .image-deleted .delete-image-btn {
            background-color: #1cc88a; /* Đổi màu nút khi hoàn tác */
        }
    </style>
</head>
...
<body id="page-top">
                                        ...
                                        <div id="currentGalleryImages" class="d-flex flex-wrap mb-3">
                                            ...
                                            ?>
                                                <div class="gallery-image-wrapper" data-image-id="<?= $image_id ?>">
                                                    ...
                                                    <span class="delete-image-btn" >
                                                        <i class="fas fa-times"></i>
                                                        <a href="?action=deleteTourImages&id=<?=$image_id ?>"></a>
                                                    </span>
                                                    <input type="hidden" name="existing_gallery_images[<?= $image_id ?>]" value="<?= $image_id ?>" class="delete-flag-input">
                                                </div>
    ...
    <script>
        ...
        function addGalleryInput(btn) {
            ...
            // 1. Tạo input group MỚI (chứa input file và nút + mới)
        ...
        /**
         * Đánh dấu ảnh gallery hiện có để xóa hoặc hoàn tác
         * @param {HTMLElement} btn - Nút xóa (X)
         * @param {number} imageId - ID của ảnh trong database
         */
    </script>
