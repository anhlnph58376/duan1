...
<head>
    ...
    <title>Hồ Sơ Tài Khoản - H2A</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Hồ Sơ Tài Khoản: <?php echo htmlspecialchars($user['username']); ?></h1>
                        <a href="?action=account_management" class="btn btn-secondary btn-sm">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="?action=account_profile_update" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <a href="?action=account_management" class="btn btn-secondary">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="mb-2">
                                        ...
                                        <p class="mb-0"><?php echo htmlspecialchars($user['id']); ?></p>
                                    </div>
                                    <div class="mb-2">
