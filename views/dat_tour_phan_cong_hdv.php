...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nút chuyển đổi Sidebar (Sidebar) -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">
                                ...
                                <?= $booking['guide_name'] ? 'Thay đổi' : 'Gán' ?> Hướng dẫn viên
                            </h6>
                        </div>
                        <div class="card-body">
                            <form action="?action=store_assign_guide" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="guide_id" name="guide_id" required>
                                        ...
                                        <option value="<?= $guide['id'] ?>" data-email="<?= $guide['email'] ?>"
                                            data-phone="<?= $guide['phone'] ?>"
                                            <?= ($booking['guide_id'] == $guide['id']) ? 'selected' : '' ?>>
                                            <?= $guide['full_name'] ?> - <?= $guide['email'] ?>
                                            <?php if ($guide['phone']): ?>
                                            - <?= $guide['phone'] ?>
                                            <?php endif; ?>
                                        </option>
                                ...
                                <div class="form-group text-right mt-4">
                                    ...
                                    <button type="submit" class="btn btn-success">
                                        ...
                                        <?= $booking['guide_name'] ? 'Thay đổi HDV' : 'Gán HDV' ?>
                                    </button>
                                </div>
                            </form>
                        </div>
    ...
    $(document).ready(function() {
        ...
        // Kích hoạt sự kiện change khi tải trang nếu HDV đã được chọn
        $('#guide_id').trigger('change');
    });
    </script>
