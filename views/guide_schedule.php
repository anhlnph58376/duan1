                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            <div class="card shadow">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Tour đã được gán</h6>
                                </div>
                                <div class="card-body">
                                            ...
                                            <table class="table table-bordered" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    <?php foreach ($assigned_tours as $tour): ?>
                                                        <tr>
                                                            <td>
                                                                <a href="?action=booking_detail&id=<?= $tour['booking_id'] ?>" class="btn btn-sm btn-outline-primary">
                                                            ...
                                                            <td>
                                                                <a href="?action=booking_detail&id=<?= $tour['booking_id'] ?>" class="btn btn-sm btn-info" title="Xem chi tiết booking">
                                                                    <i class="fas fa-eye"></i>
                                                                </a>
                                                                <?php if (!empty($tour['tour_id'])): ?>
                                                                    <a href="?action=tour_detail&id=<?= $tour['tour_id'] ?>" class="btn btn-sm btn-success" title="Xem chi tiết tour">
                                    ...
                                    <?php else: ?>
                                        <div class="alert alert-info">
                                            <i class="fas fa-info-circle"></i> Hiện tại chưa có tour nào được gán cho hướng dẫn viên này.
                                            <?php if (isset($guide) && !empty($guide['id'])): ?>
                                                <br><small class="text-muted">Debug: Guide ID <?= $guide['id'] ?> - Kiểm tra xem booking đã được gán HDV chưa.</small>
                                            <?php endif; ?>
                                        </div>
                                    <?php endif; ?>
                                </div>
