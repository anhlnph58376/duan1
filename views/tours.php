                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="dataTable" width="100%"
                                ...
                                <tr>
                                    ...
                                    <th>Ngày tạo</th>
                                    <th>Mô tả ngắn</th>
                                    <th>Quy định đặt tour</th>
                                    <th>Chính sách hoàn hủy</th>
                                    <th>Chính sách hoàn tiền</th>
                                    <th>Các dịch vụ bao gồm</th>
                                    <th>Các dịch vụ không bao gồm</th>
                                ...
                                <?php if (!empty($tours)): ?>
                                    <?php foreach ($tours as $tour): ?>
                                        <tr>
                                            ...
                                            <td><?= isset($tour['departure_date'])
                                                    ? date('d/m/Y', strtotime($tour['departure_date'])) : '-' ?></td>
                                            ...
                                            <td><?= isset($tour['created_at'])
                                                    ? date('d/m/Y', strtotime($tour['created_at'])) : '-' ?></td>
                                            <td>
                                                <?= htmlspecialchars($tour['description'] ?? '-') ?>
                                            </td>

                                            <td>
                                                <?= htmlspecialchars($tour['policy_booking'] ?? '-') ?>
                                            </td>

                                            <td>
                                                <?= htmlspecialchars($tour['policy_cancellation'] ?? '-') ?>
                                            </td>

                                            <td>
                                                <?= htmlspecialchars($tour['policy_refund'] ?? '-') ?>
                                            </td>

                                            <td>
                                                <?= htmlspecialchars($tour['included_services'] ?? '-') ?>
                                            </td>

                                            <td>
                                                <?= htmlspecialchars($tour['excluded_services'] ?? '-') ?>
                                            </td>
