                                ...
                                <div class="card-body">
                                    ...
                                    <?php if (!empty($booking['guide_id'])): ?>
                                        ...
                                        <div class="alert alert-info mb-3">
                                            <strong>HDV đã gán:</strong> <?= $currentGuide['name'] ?? 'N/A' ?>
                                            (<?= $currentGuide['email'] ?? 'N/A' ?>)
                                            <?php if (!empty($currentGuide['phone'])): ?>
                                                - ĐT: <?= $currentGuide['phone'] ?>
                                            <?php endif; ?>
                                            <a href="?action=booking_assign_guide&id=<?= $booking['id'] ?>" class="btn btn-sm btn-warning float-right">
                                                <i class="fas fa-exchange-alt"></i> Thay đổi HDV
                                            </a>
                                        </div>
                                    <?php endif; ?>
                                    <form method="POST" action="?action=store_assign_guide">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="message" id="message" class="form-control"
                                                rows="3" placeholder="Nhập yêu cầu hoặc thông tin cho hướng dẫn viên..."></textarea>
                                        </div>
                                        <div class="text-right">
                                            <button type="submit" class="btn btn-success">
                                                <i class="fas fa-user-check"></i> Gán HDV và gửi yêu cầu
                                            </button>
                                        </div>
                                    </form>
                                </div>
