...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Thanh bên -->
        <?php // tái sử dụng sidebar từ main.php bằng cách copy-paste hoặc giữ liên kết đơn giản trở lại ?>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p><strong>Mã booking:</strong>
                                        <?= htmlspecialchars($booking['booking_code'] ?? 'N/A') ?></p>
                                    ...
                                    <p><strong>Còn lại:</strong>
                                        <?= number_format(($booking['total_amount'] ?? 0) - ($booking['deposit_amount'] ?? 0), 0, ',', '.') ?>
                                        VNĐ</p>
                                </div>
                            </div>
                        </div>
