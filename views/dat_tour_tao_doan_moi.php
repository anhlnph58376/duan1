...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="index.php?action=dat_tour_chi_tiet&id=<?= $booking['id'] ?>"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <p><strong>Khách hàng:</strong>
                                                <?= htmlspecialchars($booking['customer_name'] ?? 'N/A') ?></p>
                                            <p><strong>Điện thoại:</strong>
                                                <?= htmlspecialchars($booking['customer_phone'] ?? 'N/A') ?></p>
                                        </div>
                                        <div class="col-md-6">
                                            <p><strong>Email:</strong>
                                                <?= htmlspecialchars($booking['customer_email'] ?? 'N/A') ?></p>
                                            <p><strong>Tổng tiền:</strong>
                                                <?= number_format($booking['total_amount'] ?? 0) ?> VND</p>
                                            <p><strong>Trạng thái:</strong>
                                                <span
                                                    class="badge badge-info"><?= htmlspecialchars($booking['status'] ?? 'N/A') ?></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="index.php?action=xu_ly_tao_doan_moi">
                                        <input type="hidden" name="booking_id" value="<?= $booking['id'] ?>">

                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="tour_id">Chọn tour <span
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="pax_count"
                                                        name="pax_count" value="1" min="1" max="50" required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="min_pax"
                                                        name="min_pax" value="1" min="1" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="max_pax"
                                                        name="max_pax" value="50" min="1" required>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p class="mb-3"><i class="fas fa-info-circle text-info"></i>
                                        <strong>Tạo đoàn mới từ booking</strong>
                                    </p>
                                    <ul class="mb-0">
    ...
    $(document).ready(function() {
        ...
        $('#tour_id').change(function() {
            // Cần dữ liệu thời lượng tour từ backend
            // Hiện tại, chúng ta sẽ thêm 3 ngày vào ngày khởi hành
            updateReturnDate();
        });
        ...
        function updateReturnDate() {
            ...
            if (departureDate) {
                ...
                date.setDate(date.getDate() + 3); // Mặc định 3 ngày tour
                $('#return_date').val(date.toISOString().split('T')[0]);
            }
        }

        // Đặt số người tối thiểu bằng với số người đặt tour
