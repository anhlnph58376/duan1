...
// Sử dụng dữ liệu cũ hoặc dữ liệu đặt tour hiện tại
                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="?action=updateBooking">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="booking_code">Mã booking <span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="total_amount"
                                                        name="total_amount" min="0" step="1000" required
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="deposit_amount"
                                                        name="deposit_amount" min="0" step="1000"
                        ...
                        <div class="col-xl-4">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <ul class="list-unstyled">
                                        ...
                                        <li><strong>Mã booking:</strong>
                                            <?= htmlspecialchars($booking['booking_code'] ?? '') ?></li>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <ul class="list-unstyled">
                                        <li><i class="fas fa-info-circle text-info"></i> Các trường có dấu (*) là bắt
                                            buộc</li>
                                        <li><i class="fas fa-edit text-warning"></i> Cập nhật sẽ thay đổi thông tin
                                            khách hàng</li>
                                        <li><i class="fas fa-money-bill text-primary"></i> Tổng tiền tính bằng VNĐ</li>
                                        <li><i class="fas fa-trash text-danger"></i> Xóa booking sẽ không thể khôi phục
                                        </li>
                                    </ul>
                                </div>
                            </div>
