...
class DatTour extends BaseModel
{
    // Lấy tất cả đặt tour với thông tin khách hàng
    public function getAllBookings() {
        try {
            ...
            // Dự phòng: chỉ lấy dữ liệu từ bảng bookings
            try {
    ...
    private function findOrCreateCustomer($data) {
        try {
            // Tìm khách hàng theo điện thoại hoặc email
            ...
            // Dự phòng: trả về customer_id mặc định
            return 1;
        }
    }
    ...
    // Tính tổng tiền đặt tour (trả về total_amount)
    ...
    /**
     * Lấy tất cả đặt tour với thông tin đoàn đã tham gia
     */
    public function getAllBookingsWithDepartures() {
        try {
            ...
            // Thêm thông tin đoàn cho mỗi đặt tour
