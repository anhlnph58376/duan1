...
class Doan extends BaseModel 
{
    ...
    {
        try {
            // Lấy tour_version_id mặc định cho tour này
    ...
    {
        try {
            // Kiểm tra xem có đặt tour nào liên kết không
            ...
            if ($result['count'] > 0) {
                return false; // Không thể xóa vì có đặt tour liên kết
            }
