...
class DepartureController
{
    ...
    public function index()
    {
        try {
            ...
            $availableBookings = $this->departureModel->getAvailableBookings();
    ...
    public function add() 
    {
        try {
            ...
            require_once PATH_VIEW . 'departure_add.php';
        } catch (Exception $e) {
    ...
    public function create() 
    {
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            header('Location: index.php?action=departure_add');
            exit;
        }
        ...
        try {
            ...
            $departure_id = $this->departureModel->createDeparture($data);
